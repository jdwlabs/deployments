...
def generate_html():
    ...
    chart_paths = glob.glob("charts/*/Chart.yaml")
...
<head>
    ...
    <title>Jdwlabs Deployments Helm Repository</title>
    <style>
        :root {{
...
<body>
    <div class="container">
        <header>
            <h1><a href="https://github.com/jdwlabs/deployments">Jdwlabs Deployments Helm Charts</a></h1>
            <p>Official Helm repository for Jdwlabs application deployments.</p>
        </header>

        <div class="setup-box">
            <h2 style="margin-top: 0;">Repository Setup</h2>
            <pre><button class="copy-btn" onclick="copyCode()">Copy</button><code id="code">helm repo add jdwlabs-deployments https://jdwlabs.github.io/deployments/
helm repo update</code></pre>
        ...
        <footer>
            &copy; 2026 Jdwlabs &bull; <a href="https://github.com/jdwlabs/deployments">View Source on GitHub</a>
        </footer>
    </div>
    <script>
        function copyCode() {{
